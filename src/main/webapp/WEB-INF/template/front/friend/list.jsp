...
<head>
    ...
    <title>${system.companyName}-友情链接</title>
    <meta name="keyword" content="友情链接,${system.companyName}">
    ...
    <div class="container">
        <c:choose>
            <c:when test="${fn:length(friendList)>0}">
                <c:forEach items="${friendList}" var="friend" varStatus="s">
                    <c:if test="${s.index%6==0}"><div class="row"  style="line-height: 30px;"></c:if>
                    <div class="col-xs-2">
