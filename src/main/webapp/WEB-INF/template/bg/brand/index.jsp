...
<div class="page">
    <div class="pageHeader">
        <form onsubmit="return navTabSearch(this);" action="${frontPath}/bg/brand/index.html" method="post">
            <input type="hidden" name="pageNum" value="1"/>
    ...
    <div class="pageContent">
        <div class="panelBar">
            <ul class="toolBar">
                <li>
                    <a class="add" href="/bg/brand/add.html" target="navTab" id="adv_add" rel="brand_add"><span>添加</span></a>
                </li>
                <li class="line">line</li>
                <li>
                    <a class="edit" href="/bg/brand/edit.html?id={sid_Audit}" target="navTab"
                       warn="请选择一条数据" id="adv_edit" rel="brand_edit"><span>修改</span></a>
                </li>
                <li class="line">line</li>
                <li>
                    <a class="delete" href="/bg/brand/delete.html?id={sid_Audit}"
