...
<div class="page">
    <div class="pageContent">
        ...
        <form method="post" action="/bg/download/update.html" class="pageForm required-validate"
            ...
            <div class="pageFormContent" layoutH="53">
                ...
                <div class="unit">
                    <label>文件：</label>
                    <input type="file" name="img" class="required" style="border: none;"/>
                </div>
                <div class="unit">
                    <label>下载是否需要登陆：</label>
                    <select name="enable">
                        <option value="0" <c:if test="${bean.enable eq 0}">selected="selected" </c:if> >否</option>
                        <option value="1" <c:if test="${bean.enable eq 1}">selected="selected" </c:if>>是</option>
                    </select>
                </div>
                <div class="unit">
                    <label>可用状态：</label>
