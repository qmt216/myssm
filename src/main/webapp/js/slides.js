/**
 * Created by qinmingtao on 2016/8/26.
 */
(function () {
    !function ($, t, i) {
        var e, s, n;
        return n = "slidesjs", s = {
            ...
            function t(t, i) {
                this.element = t, this.options = $.extend(!0, {}, s, i), this._defaults = s, this._name = n, this.init()
            }

            return t
        }(), e.prototype.init = function () {
            var i, e, s, n, a, o, d = this;
            return i = $(this.element), this.data = $.data(this), $.data(this, "animating", !1), $.data(this, "total", i.children().not(".slidesjs-navigation", i).length), $.data(this, "current", this.options.start - 1), $.data(this, "vendorPrefix", this._getVendorPrefix()), "undefined" != typeof TouchEvent && ($.data(this, "touch", !0), this.options.effect.slide.speed = this.options.effect.slide.speed / 2), i.css({overflow: "hidden"}), i.slidesContainer = i.children().not(".slidesjs-navigation", i).wrapAll("<div class='slidesjs-container'>", i).parent().css({
                overflow: "hidden",
                position: "relative"
            ...
            }), this.options.play.swap && o.css({display: "none"})), this.options.pagination.active && (s = $("<ul>", {"class": "slidesjs-pagination"}).appendTo(i), $.each(new Array(this.data.total), function (t) {
                var i, e;
                return i = $("<li>", {"class": "slidesjs-pagination-item"}).appendTo(s), e = $("<a>", {
                    href: "#",
            ...
            }), s.children(":eq(" + e + ")").css({display: "block", left: -this.options.width})
            ...
            return i = $(this.element), this.data = $.data(this), this.data.animating || t === this.data.current + 1 ? void 0 : ($.data(this, "animating", !0), e = this.data.current, t > -1 ? (t -= 1, h = t > e ? 1 : -1, s = t > e ? -this.options.width : this.options.width, a = t) : (h = "next" === this.data.direction ? 1 : -1, s = "next" === this.data.direction ? -this.options.width : this.options.width, a = e + h), -1 === a && (a = this.data.total - 1), a === this.data.total && (a = 0), this._setActive(a), d = $(".slidesjs-control", i), t > -1 && d.children(":not(:eq(" + e + "))").css({
                ...
                return d[0].style[l] = "", d[0].style[n] = "", d.children(":eq(" + a + ")").css({left: 0}), d.children(":eq(" + e + ")").css({
                    display: "none",
                    left: 0,
                    zIndex: 0
            ...
            })) : d.stop().animate({left: s}, this.options.effect.slide.speed, function () {
                return d.css({left: 0}), d.children(":eq(" + a + ")").css({left: 0}), d.children(":eq(" + e + ")").css({
                    display: "none",
                    left: 0,
                    zIndex: 0
            ...
            return i = $(this.element), this.data = $.data(this), this.data.animating || t === this.data.current + 1 ? void 0 : ($.data(this, "animating", !0), e = this.data.current, t ? (t -= 1, a = t > e ? 1 : -1, s = t) : (a = "next" === this.data.direction ? 1 : -1, s = e + a), -1 === s && (s = this.data.total - 1), s === this.data.total && (s = 0), this._setActive(s), n = $(".slidesjs-control", i), n.children(":eq(" + s + ")").css({
                ...
                return n.children(":eq(" + s + ")").css({zIndex: 0}), $.data(o, "animating", !1), $.data(o, "current", s), o.options.callback.complete(s + 1)
                ...
                return n.children(":eq(" + s + ")").stop().fadeIn(o.options.effect.fade.speed, function () {
                    return n.children(":eq(" + s + ")").css({zIndex: 10})
